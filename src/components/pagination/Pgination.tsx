          ...
          {currentPage > 3 && (
            <li>
              <button
                ...
                className="outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center text-lg mx-1.5"
              >
                ...
              </button>
            </li>
            ...
            pageNumber > 0 && pageNumber <= totalPages && (
              <li key={pageNumber}>
                <button
                  ...
                  className={`outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center mx-1.5 ${
          ...
          {currentPage !== totalPages && (
            <li>
              <button
                ...
                className={`outline-0 hover:text-cyan rounded-full w-8 h-8 flex items-center justify-center mx-1.5 bg-red-400`}
              >
                {totalPages}
              </button>
            </li>
