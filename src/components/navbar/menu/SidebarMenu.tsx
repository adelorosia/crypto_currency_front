 ...
 ${
    ...
    >
      <div className={`${isSidebarMenuOpen ? "" : "invisible"} duration-300`}>
        <div
          className={`flex items-center  justify-start gap-3 container px-5 shadow-sm py-4`}
        >
          ...
          />
          <Branding />
          <p className={`${isSidebarMenuOpen?" opacity-100":" opacity-0"} duration-300 font-FONT_VIGA`}>Crypto currency</p>
        </div>
        <nav className={`${isSidebarMenuOpen?" opacity-100":" opacity-0"} duration-300 flex flex-col text-xl font-FONT_VIGA`}>
